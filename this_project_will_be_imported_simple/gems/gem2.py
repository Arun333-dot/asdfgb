...
class gem2(MacroSpec):
    name: str = "gem2"
    projectName: str = "this_project_will_be_imported_simple"
    category: str = "Transform"


    @dataclass(frozen=True)
    class gem2Properties(MacroProperties):
    ...
    def apply(self, props: gem2Properties) -> str:
