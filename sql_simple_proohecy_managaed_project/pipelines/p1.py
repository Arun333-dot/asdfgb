...
with DAG(Config = Config):
    DatabricksSource_1 = SourceTask(
        ...
        tableFullName = {"database" : "qa_team", "name" : "customers", "schema" : "qa_database"}
    )
    ...
    DatabricksSource_0 = SourceTask(
        ...
        connector = Connection(kind = "databricks", authType = "pat", id = "connnection"), 
        format = DATABRICKSFormat(), 
        tableFullName = {"database" : "qa_team", "name" : "new_table", "schema" : "qa_database"}
    )
    ...
    DatabricksSource_4 = SourceTask(
        task_id = "DatabricksSource_4", 
        component = "OrchestrationSource", 
        kind = "DatabricksSource", 
        connector = Connection(kind = "databricks", authType = "pat", id = "connnection"), 
        format = DATABRICKSFormat(
