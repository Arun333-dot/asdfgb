...
class grTYvgfb(MacroSpec):
    name: str = "grTYvgfb"
    projectName: str = "redshfit_project_Sql"
    category: str = "Custom"


    @dataclass(frozen=True)
    class grTYvgfbProperties(MacroProperties):
    ...
    def apply(self, props: grTYvgfbProperties) -> str:
    ...
    def loadProperties(self, properties: MacroProperties) -> PropertiesType:
        ...
        return grTYvgfb.grTYvgfbProperties(
